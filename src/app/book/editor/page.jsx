                            ...
                            <tbody>
                                <tr className="text-ss border-b bg-zinc-800 border-zinc-700 hover:bg-zinc-600">
                                    ...
                                    <td className="px-6 py-4 font-bold">
                                        Empresa fazendo os melhores mangas a mais de 100 anos
                                    </td>
                                    <td className="px-6 py-4 font-bold">
                                        1902
                                    </td>
                ...
                <div id="form_exemplar" className="w-4/12 bg-zinc-800 mt-5 rounded-lg">
                    ...
                    <fieldset className="container px-6 py-4 items-center space-y-3">
                        ...
                        <InputTextArea
                            ID="description"
                            title='descrição'
                            placeholder='Insira uma descrição do editor' name="description"
                        />
                        <InputText
                            ID={"year"}
                            title='Ano de Criação'
                            placeholder='Insira o ano de criação da empresa'
                            name='year'
                        />
                    </fieldset>
                </div>
